...
const openOfferModal = async (e)=>{
    ...
    try {
        ...
        PRODUCT_MODAL.childNodes[4].childNodes[5].firstElementChild.firstElementChild.innerHTML= product.prices.old;//colocación de precio antiguo
...
const closeOfferModal= ()=>{
    ...
    setTimeout(()=>{
        PRODUCT_MODAL.childNodes[2].firstElementChild.setAttribute("src","images/loading.gif");//colocación de imagen
...
PRODUCT_MODAL.firstElementChild.addEventListener("click",closeOfferModal);
